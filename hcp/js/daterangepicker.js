...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.ranges !== 'undefined' && this.opens == 'right') {
            this.container.find('.ranges').prependTo(this.container.find('.drp-calendar.left').parent());
        }
    ...
    DateRangePicker.prototype = {
        ...
        renderTimePicker: function (side) {
            ...
            if (side == 'left') {
                ...
                var timeSelector = this.container.find('.drp-calendar.right .calendar-time div');
            ...
            this.container.find('.drp-calendar.' + side + ' .calendar-time div').html(html);
        ...
        formInputsChanged: function (e) {
            var isRight = $(e.target).closest('.drp-calendar').hasClass('right');
